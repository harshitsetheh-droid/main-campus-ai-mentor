...
import { MessageSquare, ChevronLeft, Send, Users, ShieldCheck, Smile, UserPlus } from 'lucide-react';
            ...
            >
              <div className="flex items-start justify-between gap-3">
                ...
                <span className="inline-flex items-center gap-1 text-[10px] font-bold text-[#c6c5d7] bg-white/5 border border-white/10 px-2 py-0.5 rounded-full">
                  <Users className="w-3 h-3" /> {c.members || 0}
                </span>
              </div>
              ...
              <div className="mt-3 flex items-center gap-1.5 text-[10px] font-bold text-[#3cd7ff] uppercase tracking-wide">
                Join chat <ChevronLeft className="w-3.5 h-3.5 rotate-180 group-hover:translate-x-0.5 transition-transform" />
              </div>
            </button>
          ))}
        </div>
            ...
            <div className="flex items-center gap-3 min-w-0">
              ...
              <div className="min-w-0">
                ...
                <p className="text-[11px] text-[#c6c5d7] flex items-center gap-1.5">
                  ...
                  Anonymous · {messages.length} messages
                </p>
              </div>
            </div>
            <span className="hidden sm:inline-flex items-center gap-1.5 text-[10px] font-bold text-emerald-300 bg-emerald-500/10 border border-emerald-500/30 px-2.5 py-1 rounded-full shrink-0">
